...
from fixtures.files import files_client, FileFixture
from tools.assertions.base import assert_status_code
from tools.assertions.files import assert_create_file_response, assert_get_file_response, assert_file_is_accessible, \
...
class TestFiles:
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient):
        ...
        get_response_data = ValidationErrorResponseSchema.model_validate_json(get_file_response.text)
        ...
        validate_json_schema(get_file_response.json(), get_response_data.model_json_schema())
