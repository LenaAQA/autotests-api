...
def assert_get_user_response(
    ...
    """
    Проверяет, что данные пользователя,
    полученные при запросе, совпадают с данными при создании.

    :param get_user_response: Ответ API при получении текущего пользователя.
